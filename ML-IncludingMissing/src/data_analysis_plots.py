...
def data_analysis_charts(df: pd.DataFrame, show_plot: bool):
    ...
    plot_missing_values_percentage(df, "ML-IncludingMissing/plots/01_missing_values_percentage.png", show_plot)

    # Plot correlations to price
    plot_correlations_to_price(df, "ML-IncludingMissing/plots/02_correlation_with_variable_price.png", show_plot)

    # Plot other correlations
    # Correlation between count-based features (Pearson Correlation)
    plot_count_features_correlations(df, "ML-IncludingMissing/plots/03_count_features_correlations.png", show_plot)

    # Plot the outliers
    plot_outliers(df, "ML-IncludingMissing/plots/04_outliers.png", show_plot)
